...
class LoggerService {
     ...
     */
    debug(message, data, serviceName, uuid) {
        return this.#log('DEBUG', message, data, serviceName, uuid);
    }
     ...
     * @returns {Object|string|undefined}
     */
    info(message, data, serviceName, uuid) {
        return this.#log('INFO', message, data, serviceName, uuid);
    }
     ...
     * @returns {Object|string|undefined}
     */
    warn(message, data, serviceName, uuid) {
        return this.#log('WARN', message, data, serviceName, uuid);
    }
     ...
     * @returns {Object|string|undefined}
     */
    error(message, data, serviceName, uuid) {
        return this.#log('ERROR', message, data, serviceName, uuid);
    }
     ...
     * @returns {Object|string|undefined}
     */
    fatal(message, data, serviceName, uuid) {
        return this.#log('FATAL', message, data, serviceName, uuid);
    }
     ...
     */
    #log(type, message, data = null, serviceName = null, uuid = null) {
        ...
        const { contextData, contextService } = this.context.inject(data, serviceName);
    ...
    // TODO: Problema de clonagem dos serviços e objetos do 'child()'.
    // https://github.com/NicolasChirazawa/micro-log-lib/issues/4.
    /**
    ...
    child({data = null, serviceName = ''}) {
        ...
        const fatherContext = this.context.get();
        loggerChild.context.create(data, serviceName, fatherContext);
