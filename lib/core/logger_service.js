...
const { ContextualizerService } = require('./contextualizer_service');
...
class LoggerService {
    ...
    #log(type, message, fields = undefined) {
        ...
        const data = this.contextualizer.inject(fields);
     ...
     * @param {Object} contextualizer - Context on class
     */
    child(fields) {
        ...
        const contextualizer = this.contextualizer.clone();
        ...
        loggerChild.contextualizer.create(fields);
        return loggerChild;
    };
}
